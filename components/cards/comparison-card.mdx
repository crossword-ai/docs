...
description: "The comparison card sets two or more products side by side across the attributes that matter and explains the differences, so the shopper can choose."
---
...
<Frame caption="A comparison card across five attributes">
  <img src="/images/cards/comparison-card.png" alt="A comparison card across five attributes" />
</Frame>
...
Products side by side, compared on the attributes that matter for the choice.

```yaml
Products: Two or more, each with an image and title; more scroll in from the right
Attributes: Best for, cushioning, weight, upper, price
Details: A View link on each product that opens its page
```

The shopper reads down a row to see how the products differ, and scrolls sideways when there are more than two.
