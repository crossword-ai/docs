...
flowchart TB
  ...
  PRIM["Primitives<br/><small>input and selector</small>"]
  IT -. "built from" .-> PRIM
  AG["Agent"]
...
The [discovery experiment](/use-cases/discovery-experiment) uses the same quiz in one Journey and leaves it out of another to measure which discovery method converts better.
