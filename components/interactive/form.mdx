---
title: "Form"
description: "Forms collect details inside the conversation, such as an email for a back-in-stock alert, with field validation, consent, and a Workflow on submit."
---
