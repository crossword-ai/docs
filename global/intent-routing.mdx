...
description: "Intent routing reads each question a shopper types and sends it to the right Agent. Tapped starters and proactive messages skip it and go straight through."
---
