---
title: "Workflows"
description: "Workflows run multi-step actions such as tracking an order or starting a return. Each one follows a fixed path with defined inputs, outputs, and errors."
---
