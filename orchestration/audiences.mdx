...
flowchart TB
  ...
  subgraph USERS["Who uses segments"]
    ...
    RULE["Rules on components<br/><small>test membership</small>"]
  end
  SEG -. "used by" .-> USERS
```
