...
Deployment acts on the whole experience. A revision is a snapshot of every Playbook, Rulebook, Campaign, page, and Experiment at the moment you publish.
...
For a website, copy the environment's **installation snippet** into your site. For a conversational channel such as Instagram or iMessage, connect the channel account to the environment instead. Read [Quickstart](/quickstart) for the first installation.
