...
description: "Journeys react to what is true for a shopper right now. Campaigns follow a shopper over hours or days. Learn which one to use for the behavior you need."
---
